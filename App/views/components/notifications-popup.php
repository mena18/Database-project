<div class="creat-post" id="notifications-container">
    <div class="create-post-form">
        <div class="header row">
            ...
            <div class="col-md-2">
                <i class="fas fa-times-circle btn" id="create-post-close-btn" onclick="hide_form('notifications-container')"></i>
            </div>
        </div>
        <hr>
        <div class="outer-container">
            <div class="notifications-list row">
                <a href="" class="notification-container col-12 text-left pl-4">
